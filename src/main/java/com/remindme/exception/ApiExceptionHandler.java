package com.remindme.exception;
...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<Object>handleBadInputException(BadInputException e)
    {
        ApiException apiException=new ApiException(
                e.getMessage(),
                e,
    ...
    public ResponseEntity<Object>handleNamingConflictException(NamingConflictException e)
    {
        ApiException apiException=new ApiException(
                e.getMessage(),
                e,
